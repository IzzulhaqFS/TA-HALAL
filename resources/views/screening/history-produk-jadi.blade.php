...
@section('subhead')
    <title>History Screening Produk Jadi</title>
@endsection

@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Daftar Produk Jadi</h2>
    @if ($errors->any())
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('screening.produk-jadi') }}" class="btn btn-primary inline-block mr-1 mb-2 pr-5"><i data-lucide="plus" class="w-5"></i> Cek Produk Baru</a>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="text-center whitespace-nowrap">DAFTAR BAHAN</th>
                ...
                <tbody>
                    @foreach ($products as $key => $product)
                        <tr class="intro-x">
                            ...
                            <td>
                                <p class="font-medium text-center">{{ $product->daftar_bahan }}</p>
                            </td>
                            <td>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-body p-0">
                                        <form action="{{ route('screening.destroy-produk-jadi', ['screening_produk_jadi_id'=> $product->id]) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
