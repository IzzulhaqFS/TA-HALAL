                    ...
                    <div class="preview">
                        ...
                        <form id="cek-kulit-form" action="{{ route('hewani.bahan-baku.process', ['ingredient_id' => $ingredient->id]) }}" method="GET">
                            <div class="mt-3">
                                ...
                                <label for="regular-form-1" class="form-label">Apakah hewan asal kulit diketahui?</label>
                            ...
                            <div id="asal-hewan-halal" class="asal-hewan-halal main-activity" 
                                ...
                                data-value="">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label">Apakah kulit berasal dari hewan halal?</label>
