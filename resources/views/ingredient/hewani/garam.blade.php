<div id="garam-container" class="mt-6">
    ...
    data-value="">
        <div class="mt-3">
            <label for="regular-form-1" class="form-label font-medium">Apakah garam telah bersertifikat halal? <span class="text-danger">*</span></label>
            <select id="is-garam-certified-select" class="form-control" name="is-garam-certified">
                ...
                <option value="0" {{ old('is-garam-certified') == '0' ? 'selected' : '' }} class="sub-activity" data-pos="" data-label="Apakah garam telah bersertifikat halal?">Belum</option>
            </select>
        </div>
        <div class="mt-3">
    ...
    <div id="garam-certificate-detail" class="main-activity" style="display: none;"
        data-pos="" 
