                    ...
                    <div class="preview">
                        ...
                        <form id="cek-jerohan-form" action="{{ route('hewani.bahan-baku.process', ['ingredient_id' => $ingredient->id]) }}" method="GET">
                            <div class="mt-3">
                                ...
                                <label for="regular-form-1" class="form-label">Apakah hewan asal jerohan diketahui?</label>
                            ...
                            <div id="asal-hewan-halal" class="asal-hewan-halal main-activity" 
                                ...
                                data-value="">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label">Apakah jerohan berasal dari hewan halal?</label>
