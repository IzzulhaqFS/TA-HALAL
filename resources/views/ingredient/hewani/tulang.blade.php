...
@section('subhead')
    <title>Pengecekan Bahan Tulang</title>
@endsection
...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 id="main-header" class="text-lg font-medium mr-auto main-activity" 
            data-pos="0" 
            data-label="Cek Tulang" 
            data-value="Syubhat">
            Pengecekan Bahan Tulang
        </h2>
    </div>
    @if ($errors->any())
...
<div class="flex flex-col sm:flex-row items-center px-5 py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                ...
                <div id="input" class="p-5">
                    <div class="preview">
                        ...
                        {{-- BEGIN: Form --}}
                        <form id="cek-tulang-form" action="{{ route('hewani.bahan-baku.process', ['ingredient_id' => $ingredient->id]) }}" method="GET">
                            <div class="mt-3">
                                ...
                                <select id="asal-hewan-diketahui-select" class="form-control" name="asal-hewan-diketahui">
                                    ...
                                    <option value="0" {{ old('asal-hewan-diketahui') == '0' ? 'selected' : '' }} class="sub-activity" data-pos="0" data-label="Apakah hewan asal tulang diketahui?">Tidak Diketahui</option>
                                </select>
                            </div>
    
                            {{-- BEGIN: Cek Asal Hewan Tulang--}}
                            <div id="asal-hewan-halal" class="asal-hewan-halal main-activity" 
                                ...
                                <div class="mt-4">
                                    ...
                                    <select id="asal-hewan-select" class="form-control" name="asal-hewan">
                                        ...
                                        <option value="0" {{ old('asal-hewan') == '0' ? 'selected' : '' }} class="sub-activity" data-pos="1" data-label="Apakah tulang berasal dari hewan halal?">Tidak</option>
                                    </select>
                                </div>
                                <div class="mt-3">
                            ...
                            {{-- END: Cek Asal Hewan Tulang --}}
    
                            {{-- BEGIN: Cek COA Babi Tulang --}}
                            <div id="uji-babi-detail" class="uji-babi-detail main-activity" 
                                data-pos="2"
                                data-label="Cek COA DNA Babi pada Tulang"
                                data-value="">
                                <div class="mt-4">
