                    ...
                    <div class="preview">
                        ...
                        <form id="cek-lemak-form" action="{{ route('hewani.bahan-baku.process', ['ingredient_id' => $ingredient->id]) }}" method="GET">
                            <div class="mt-3">
                                ...
                                <label for="regular-form-1" class="form-label">Apakah hewan asal lemak diketahui? <span class="text-danger">*</span></label>
                            ...
                            <div id="asal-hewan-halal" class="asal-hewan-halal main-activity" 
                                ...
                                data-value="">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label">Apakah lemak berasal dari hewan halal? <span class="text-danger">*</span></label>
