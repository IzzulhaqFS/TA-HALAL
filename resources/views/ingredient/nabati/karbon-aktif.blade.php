...
@section('subhead')
    <title>Pengecekan Karbon Aktif</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 id="main-header" class="text-lg mr-auto">
            Pengecekan Karbon Aktif
        </h2>
    </div>
    @if ($errors->any())
                    ...
                    <div class="preview">
                        ...
                        <form id="titik-kritis-form" action="{{ route('nabati.titik-kritis', [
                            ...
                            <div id="dp0" class="main-activity" style="display: block;" 
                                data-pos="0" 
                                data-label="Cek sumber karbon aktif" 
                                data-value="Syubhat">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label font-medium">Sumber karbon aktif?</label>
                                    <select id="dp0_1" class="form-control" name="dp0_1">
                                        <option value="">-- Pilih --</option>
                                        <option value="Tumbuhan" {{ old('dp0_1') == "Tumbuhan" ? 'selected' : '' }} class="sub-activity" data-pos="0" data-label="Sumber karbon aktif?">Tumbuhan</option>
                                        <option value="Hewan" {{ old('dp0_1') == "Hewan" ? 'selected' : '' }} class="sub-activity" data-pos="0" data-label="Sumber karbon aktif?">Hewan</option>
                                        <option value="Bahan tambang" {{ old('dp0_1') == "Bahan tambang" ? 'selected' : '' }} class="sub-activity" data-pos="0" data-label="Sumber karbon aktif?">Bahan tambang</option>
                                    </select>
                                </div>
                            </div>
                            {{-- END: DATA POS 0 --}}
                            ...
                            <div id="dp1" class="main-activity" style="display: none;" 
                                data-pos="1" 
                                data-label="Cek kehalalan hewan (karbon aktif)" 
                                data-value="">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label">Kehalalan hewan sumber karbon aktif?</label>
                                    <select id="dp1_1" class="form-control" name="dp1_1">
                                        <option value="">-- Pilih --</option>
                                        <option value="Halal" {{ old('dp1_1') == "Halal" ? 'selected' : '' }} class="sub-activity" data-pos="1" data-label="Kehalalan hewan sumber karbon aktif?">Halal</option>
                                        <option value="Haram" {{ old('dp1_1') == "Haram" ? 'selected' : '' }} class="sub-activity" data-pos="1" data-label="Kehalalan hewan sumber karbon aktif?">Haram</option>
                                    </select>
                                </div>
                            </div>
                            {{-- END: DATA POS 1 --}}
                            ...
                            <div id="dp2" class="main-activity" style="display: none;" 
                                data-pos="2" 
                                data-label="Cek metode penyembelihan (karbon aktif)" 
                                data-value="">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label">Apakah metode penyembelihan hewan sumber karbon aktif sesuai syari'at Islam?</label>
                                    <select id="dp2_1" class="form-control" name="dp2_1">
                                        <option value="">-- Pilih --</option>
                                        <option value="1" {{ old('dp2_1') == "1" ? 'selected' : '' }} class="sub-activity" data-pos="2" data-label="Apakah metode penyembelihan hewan sumber karbon aktif sesuai syari'at Islam?">Iya</option>
                                        <option value="0" {{ old('dp2_1') == "0" ? 'selected' : '' }} class="sub-activity" data-pos="2" data-label="Apakah metode penyembelihan hewan sumber karbon aktif sesuai syari'at Islam?">Tidak</option>
                                    </select>
                                </div>
                            </div>
                            {{-- END: DATA POS 2 --}}
    ...
    <script>
        ...
        // Kehalalan hewan sumber karbon aktif?
