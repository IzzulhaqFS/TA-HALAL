...
@section('subcontent')
                    ...
                    <div class="preview">
                        ...
                        <form id="titik-kritis-form" action="{{ route('nabati.titik-kritis', [
                            ...
                            <div id="dp0" class="main-activity" style="display: block;" 
                                data-pos="0" 
                                data-label="Cek kandungan resin" 
                                data-value="Syubhat">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label font-medium">Apakah ada penggunaan gelatin pada proses pembuatan resin</label>
                                    <select id="dp0_1" class="form-control" name="dp0_1">
                                        <option value="">-- Pilih --</option>
                                        <option value="1" {{ old('dp0_1') == "1" ? 'selected' : '' }} class="sub-activity" data-pos="0" data-label="Apakah ada penggunaan gelatin pada proses pembuatan resin">Ada</option>
                                        <option value="0" {{ old('dp0_1') == "0" ? 'selected' : '' }} class="sub-activity" data-pos="0" data-label="Apakah ada penggunaan gelatin pada proses pembuatan resin">Tidak ada</option>
                                    </select>
                                </div>
                            </div>
                            {{-- END: DATA POS 0 --}}
                            ...
                            <div id="dp1" class="main-activity" style="display: none;" 
                                data-pos="1" 
                                data-label="Cek kehalalan hewan (resin)" 
                                data-value="">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label">Kehalalan hewan sumber gelatin pada resin?</label>
                                    <select id="dp1_1" class="form-control" name="dp1_1">
                                        <option value="">-- Pilih --</option>
                                        <option value="Halal" {{ old('dp1_1') == "Halal" ? 'selected' : '' }} class="sub-activity" data-pos="1" data-label="Kehalalan hewan sumber gelatin pada resin?">Halal</option>
                                        <option value="Haram" {{ old('dp1_1') == "Haram" ? 'selected' : '' }} class="sub-activity" data-pos="1" data-label="Kehalalan hewan sumber gelatin pada resin?">Haram</option>
                                    </select>
                                </div>
                            </div>
                            {{-- END: DATA POS 1 --}}
                            ...
                            <div id="dp2" class="main-activity" style="display: none;" 
                                data-pos="2" 
                                data-label="Cek metode penyembelihan (resin)" 
                                data-value="">
                                <div class="mt-4">
                                    <label for="regular-form-1" class="form-label">Apakah metode penyembelihan hewan sumber gelatin pada resin sesuai syari'at Islam?</label>
                                    <select id="dp2_1" class="form-control" name="dp2_1">
                                        <option value="">-- Pilih --</option>
                                        <option value="1" {{ old('dp2_1') == "1" ? 'selected' : '' }} class="sub-activity" data-pos="2" data-label="Apakah metode penyembelihan hewan sumber gelatin pada resin sesuai syari'at Islam?">Iya</option>
                                        <option value="0" {{ old('dp2_1') == "0" ? 'selected' : '' }} class="sub-activity" data-pos="2" data-label="Apakah metode penyembelihan hewan sumber gelatin pada resin sesuai syari'at Islam?">Tidak</option>
                                    </select>
                                </div>
                            </div>
                            {{-- END: DATA POS 2 --}}
    ...
    <script>
        ...
        // Kehalalan hewan sumber gelatin pada resin?
