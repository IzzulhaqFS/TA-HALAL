                        ...
                        <form id="titik-kritis-form" action="{{ route('nabati.titik-kritis', [
                            ...
                            <div id="dp0" class="main-activity" style="display: block;" 
                                ...
                                <div class="mt-4">
                                    ...
                                    <label for="regular-form-1" class="form-label font-medium">Sumber enzim? <span class="text-danger">*</span></label>
                            ...
                            <div id="dp2" class="main-activity" style="display: none;" 
                                ...
                                <div class="mt-4">
                                    ...
                                    <select id="dp2_1" class="form-control" name="d4_1">
                                        <option value="">-- Pilih --</option>
                            ...
                            <div id="dp5" class="main-activity" style="display: none;" 
                                ...
                                <div class="mt-4">
                                    ...
                                    <select id="dp5_1" class="form-control" name="d4_1">
                                        <option value="">-- Pilih --</option>
                            ...
                            <div id="dp6" class="main-activity" style="display: none;" 
                                ...
                                <div class="mt-4">
                                    ...
                                    <select id="dp6_1" class="form-control" name="d4_1">
                                        <option value="">-- Pilih --</option>
